        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                  <h2 class="text-xl py-2">{{__('Edit')}}</h2>
                      ...
                      <div class="mt-5 md:mt-0 md:col-span-3">
                        <form action="{{route('books.update', $book)}}" method="POST">
                          ...
                          <div class="shadow overflow-hidden sm:rounded-md">
                            ...
                            <div class="px-2 py-3 bg-gray-50 sm:px-6 grid grid-cols-8 gap-x-4">
                              <a class="col-span-2 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-gray-400 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                                href="{{ route('books.show', $book) }}">{{ __('Back') }}</a>
                              <div class="col-span-2 ">&nbsp;</div>
                              <div class="col-span-2 ">&nbsp;</div>
                              <button type="submit" class="col-span-2 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                {{__('Update')}}
                              </button>
                            </div>
                          </div>
